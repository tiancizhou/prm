...
-- 创建常用索引
CREATE INDEX idx_requirement_project  ON pm_requirement(project_id);
CREATE INDEX idx_requirement_sprint   ON pm_requirement(sprint_id);
CREATE INDEX idx_task_project         ON pm_task(project_id);
CREATE INDEX idx_task_sprint          ON pm_task(sprint_id);
CREATE INDEX idx_task_assignee        ON pm_task(assignee_id);
CREATE INDEX idx_bug_project          ON pm_bug(project_id);
CREATE INDEX idx_bug_sprint           ON pm_bug(sprint_id);
CREATE INDEX idx_bug_assignee         ON pm_bug(assignee_id);
CREATE INDEX idx_operation_log_biz    ON pm_operation_log(biz_type, biz_id);
CREATE INDEX idx_dashboard_project    ON pm_dashboard_snapshot(project_id, snap_date);
CREATE INDEX idx_attachment_biz       ON pm_attachment(biz_type, biz_id);
